...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(8, 0, 0,12.89 );
     ...
     */
    public static double MAX_VEL = 54; //back and forth shimmy can be reduced by reducing this number
