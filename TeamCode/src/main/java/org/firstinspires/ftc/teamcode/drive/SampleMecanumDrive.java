...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public SampleMecanumDrive(HardwareMap hardwareMap) {
        ...
        //motors
        xRailExt = hardwareMap.get(DcMotorEx.class, "xRailExt");
        xRailRot = hardwareMap.get(DcMotorEx.class, "xRailRot");

        xRailRot.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
        xRailExt.setMode(DcMotor.RunMode.RUN_USING_ENCODER);

        xRailRot.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        xRailExt.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
