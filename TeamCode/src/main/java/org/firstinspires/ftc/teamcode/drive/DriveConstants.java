...
public class DriveConstants {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(8, 0, 0,12.892 );
     ...
     */
    public static double MAX_VEL = 53; //back and forth shimmy can be reduced by reducing this number
    public static double MAX_ACCEL = 52.48180821614297;
    public static double MAX_ANG_VEL = Math.toRadians(175.12);
